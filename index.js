...
raisedCard.textContent = totalAmountRaised.toLocaleString('en-US', {style: 'currency', currency: 'USD'}).slice(0, -3);
...
const message = `A total of $${totalAmountRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numberOfUnfundedGames} ${
...
const [topPledged, secondPledged, ...otherGames] = sortedGames;

// create a new element to hold the name of the top pledge game, then append it to the correct element
const firstGameName = document.createElement("p");
firstGameName.textContent = topPledged.name;

firstGameContainer.appendChild(firstGameName);

// do the same for the runner up item
const secondGameName = document.createElement("p");
secondGameName.textContent = secondPledged.name;
